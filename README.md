...
This project aims [1] to share practical knowledge about how to apply NLP techniques and [2] to create a custom, domain specific ---medical---  corpus derived from clinical narratives ---allied-healthcare medical case-studies--- through the use of data engineering [DE](https://robfvdw.medium.com/a-generic-approach-to-data-driven-activities-d85ad558b5fa) + data science [DS](https://robfvdw.medium.com/a-generic-approach-to-data-driven-activities-d85ad558b5fa) techniques and standards such as The CRoss Industry Standard Process for Data Mining [CRISP-DM](https://www.datascience-pm.com/crisp-dm-2/). 
